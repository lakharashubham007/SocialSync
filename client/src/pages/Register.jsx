          ...
          >
            <div className='w-full flex flex-row gap-1 md:gap-2'>
              <TextInput
                ...
                styles="w-full "
                labelStyle="ml-2"
                error={errors.fname ? errors.fname.message : ""}
              />
              <TextInput
                name="lname"
            ...
            {isSubmitting ? (
              ...
              <CustomButton
                type="submit"
                containerStyles={`inline-flex justify-center rounded-md bg-[#39B5E0] px-8 py-3 text-sm font-medium mt-6 text-white outline-none`}
